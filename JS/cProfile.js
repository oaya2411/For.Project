...
async function getEditData(){
  ...
  document.body.classList.add('loading-active');
    ...
    let selectedIndustry = document.getElementById('selectedIndustry');
      
      phoneNumber.value = userData.userData.phoneNumber; 
      selectedCountry.textContent = userData.userData.country;
      selectedCity.textContent = userData.userData.city;
      selectedIndustry.textContent = userData.userData.industry;
      company.value = userData.userData.companyName;
